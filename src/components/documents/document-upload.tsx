...
import { uploadDocument, checkDuplicateName } from "@/actions/documents";
    ...
    <>
      ...
      {duplicateInfo && pendingFile && (
        <UploadVersionDialog
          ...
          existingVersion={duplicateInfo.currentVersion}
          dealId={dealId}
          workstreamId={duplicateInfo.workstreamId}
          taskId={duplicateInfo.taskId}
        />
      )}
    </>
  );
