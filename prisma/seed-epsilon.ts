...
async function main() {
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 1 — Day 1: Deal Intake (2025-09-07)
  // ═══════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 2 — Day 3: Client Pitch & Engagement (2025-09-09)
  // ═══════════════════════════════════════════════════════════
  ...
  const wsClient = await prisma.workstream.create({
    data: { name: "客户沟通", dealId: deal.id, sortOrder: 0, createdAt: d("2025-09-09") },
  });
  const wsDD = await prisma.workstream.create({
    data: { name: "尽职调查", dealId: deal.id, sortOrder: 1, createdAt: d("2025-09-09") },
  });
  const wsSPA = await prisma.workstream.create({
    data: { name: "交易文件", dealId: deal.id, sortOrder: 2, createdAt: d("2025-09-09") },
  });
  const wsReg = await prisma.workstream.create({
    data: { name: "监管审批", dealId: deal.id, sortOrder: 3, createdAt: d("2025-09-09") },
  });
  const wsStructure = await prisma.workstream.create({
    data: { name: "交易架构", dealId: deal.id, sortOrder: 4, createdAt: d("2025-09-09") },
  });
  ...
  await prisma.milestone.createMany({
    data: [
      { name: "NDA签署", date: d("2025-09-16"), type: MilestoneType.External, sortOrder: 0, dealId: deal.id, createdAt: d("2025-09-09"), updatedAt: d("2025-09-09") },
      { name: "LOI签署", date: null, type: MilestoneType.Contractual, sortOrder: 1, dealId: deal.id, createdAt: d("2025-09-09"), updatedAt: d("2025-09-09") },
      { name: "尽调完成", date: null, type: MilestoneType.Internal, sortOrder: 2, dealId: deal.id, createdAt: d("2025-09-09"), updatedAt: d("2025-09-09") },
      { name: "SPA签署", date: null, type: MilestoneType.Contractual, sortOrder: 3, dealId: deal.id, createdAt: d("2025-09-09"), updatedAt: d("2025-09-09") },
      { name: "交割", date: null, type: MilestoneType.Contractual, sortOrder: 4, dealId: deal.id, createdAt: d("2025-09-09"), updatedAt: d("2025-09-09") },
    ],
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 3 — Week 1: NDA & Preliminary Work (2025-09-11 to 12-10)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 3: NDA & Preliminary Work",
    "2025-09-11 to 2025-09-16",
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-09-11"), updatedAt: d("2025-09-11") },
  });
  ...
  await prisma.task.update({
    where: { id: taskNDA.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-09-11") },
  });
  ...
  await prisma.task.update({
    where: { id: taskNDA.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-09-12"), updatedAt: d("2025-09-12") },
  });
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-09-14") },
  });
  ...
  if (milestoneNDA) {
    await prisma.milestone.update({
      ...
      data: { isDone: true, updatedAt: d("2025-09-16") },
    });
  }
  logAction("Milestone completed: NDA签署 (2025-09-16)");

  await prisma.task.update({
    where: { id: taskPrelimResearch.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-09-16"), updatedAt: d("2025-09-16") },
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 4 — Week 2-3: Due Diligence Kickoff (2025-09-18 to 12-25)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 4: Due Diligence Kickoff",
    "2025-09-18 to 2025-10-01",
  ...
  await prisma.deal.update({ where: { id: deal.id }, data: { phase: DealPhase.DueDiligence, updatedAt: d("2025-09-18") } });
  logAction("Deal phase advanced to DueDiligence");

  // VN law research done
  await prisma.task.update({
    where: { id: taskVNLaw.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-09-18"), updatedAt: d("2025-09-18") },
  });
  ...
  await prisma.timeEntry.create({
    data: {
      ...
      userId: chenyu.id,
      dealId: deal.id,
      createdAt: d("2025-09-18"),
      updatedAt: d("2025-09-18"),
    },
  });
  ...
  const taskDDList = await prisma.task.create({
    data: {
      ...
      priority: TaskPriority.High,
      dueDate: d("2025-09-19"),
      completedAt: d("2025-09-19"),
      workstreamId: wsDD.id,
      assigneeId: zhanglin.id,
      sortOrder: 1,
      createdAt: d("2025-09-18"),
      updatedAt: d("2025-09-19"),
    },
  });
  ...
  const taskVDR = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.Done,
      priority: TaskPriority.High,
      dueDate: d("2025-09-21"),
      completedAt: d("2025-09-21"),
      workstreamId: wsDD.id,
      assigneeId: chenyu.id,
      sortOrder: 2,
      createdAt: d("2025-09-18"),
      updatedAt: d("2025-09-21"),
    },
  });
  ...
  const taskDDCorp = await prisma.task.create({
    data: {
      ...
      priority: TaskPriority.High,
      dueDate: d("2025-10-17"),
      workstreamId: wsDD.id,
      assigneeId: zhanglin.id,
      sortOrder: 3,
      createdAt: d("2025-09-21"),
      updatedAt: d("2025-09-26"),
    },
  });
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "准备尽调请求清单（中英文，涵盖公司、合同、IP、劳动、环保、诉讼等）", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskDDList.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-09-19"), updatedAt: d("2025-09-19") },
      { description: "VDR文件整理和索引建立", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskVDR.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-09-21"), updatedAt: d("2025-09-21") },
      { description: "公司治理文件审阅（章程、股东会决议、董事会决议）", durationMinutes: 300, isManual: true, isBillable: true, taskId: taskDDCorp.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-09-26"), updatedAt: d("2025-09-26") },
      { description: "重大合同初步审阅（供应商合同、分销协议）", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskDDContract.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-09-26"), updatedAt: d("2025-09-26") },
    ],
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 5 — Month 1: Deep DD & Structure Decision (2025-10-12 to 01-20)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 5: Deep DD & Structure Decision",
    "2025-10-12 to 2025-10-27",
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-10-15"), updatedAt: d("2025-10-15") },
  });

  // IP DD in progress
  await prisma.task.update({
    where: { id: taskDDIP.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-10-12") },
  });

  // Labor DD in progress
  await prisma.task.update({
    where: { id: taskDDLabor.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-10-17") },
  });
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "股权结构分析：发现15%少数股东有优先购买权", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskDDCorp.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-10-13"), updatedAt: d("2025-10-13") },
      { description: "历史股东会及董事会决议审阅完成", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskDDCorp.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-10-15"), updatedAt: d("2025-10-15") },
      { description: "重大合同深入审阅（主要客户合同、独家分销协议、OEM协议）", durationMinutes: 360, isManual: true, isBillable: true, taskId: taskDDContract.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-10-15"), updatedAt: d("2025-10-15") },
      { description: "药品注册许可证清单整理，发现关键产品注册将于18个月内到期", durationMinutes: 300, isManual: true, isBillable: true, taskId: taskDDIP.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-10-17"), updatedAt: d("2025-10-17") },
      { description: "劳动合同抽样审阅、社保合规性检查", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskDDLabor.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-10-19"), updatedAt: d("2025-10-19") },
      { description: "环保许可证及EHS合规审查", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskDDEnv.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-10-19"), updatedAt: d("2025-10-19") },
      { description: "交易架构比较分析备忘录", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskStructure.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-10-17"), updatedAt: d("2025-10-17") },
    ],
  });
  ...
  const decisionTax = await prisma.decision.create({
    data: {
      ...
      dealId: deal.id,
      workstreamId: wsDD.id,
      createdAt: d("2025-10-17"),
      updatedAt: d("2025-10-17"),
    },
  });
  ...
  const decisionDrugReg = await prisma.decision.create({
    data: {
      ...
      dealId: deal.id,
      workstreamId: wsDD.id,
      createdAt: d("2025-10-19"),
      updatedAt: d("2025-10-19"),
    },
  });
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-10-22"), updatedAt: d("2025-10-22") },
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 6 — Month 2: LOI Negotiation (2025-11-01 to 02-15)
  // ═══════════════════════════════════════════════════════════
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-10-27"), updatedAt: d("2025-10-27") },
  });
  await prisma.task.update({
    where: { id: taskDDIP.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-10-29"), updatedAt: d("2025-10-29") },
  });
  await prisma.task.update({
    where: { id: taskDDLabor.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-10-27"), updatedAt: d("2025-10-27") },
  ...
  const taskDDReport = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.InProgress,
      priority: TaskPriority.High,
      dueDate: d("2025-11-06"),
      workstreamId: wsDD.id,
      assigneeId: zhanglin.id,
      sortOrder: 8,
      createdAt: d("2025-10-29"),
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "尽调报告起草（公司治理、合同、IP部分）", durationMinutes: 480, isManual: true, isBillable: true, taskId: taskDDReport.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-11-04"), updatedAt: d("2025-11-04") },
      { description: "尽调报告起草（劳动、环保、诉讼部分）", durationMinutes: 360, isManual: true, isBillable: true, taskId: taskDDReport.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-11-04"), updatedAt: d("2025-11-04") },
      { description: "LOI起草，包含价格、架构、排他期、主要条件前提", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskLOIDraft.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-11-06"), updatedAt: d("2025-11-06") },
      { description: "少数股东权利分析备忘录，优先购买权waiver方案", durationMinutes: 300, isManual: true, isBillable: true, taskId: taskMinority.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-11-06"), updatedAt: d("2025-11-06") },
    ],
  });

  // DD report completed (formal sign-off after LOI, before SPA)
  await prisma.task.update({
    where: { id: taskDDReport.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-12-20"), updatedAt: d("2025-12-20") },
  });
  ...
  if (milestoneDDObj) {
    await prisma.milestone.update({
      ...
      data: { isDone: true, date: d("2025-12-20"), updatedAt: d("2025-12-20") },
    });
  }
  logAction("Milestone completed: 尽调完成 (2025-12-20)");
  ...
  await prisma.activityEntry.create({
    data: {
      type: ActivityType.Note,
      content: "LOI修订版已发出。最终商业条款：收购价4800万美元（考虑税务争议调减200万），排他期75天，Lock-box date设为2025-10-07。少数股东同意tag-along出售，waiver letter由Lexcomm协助起草中。",
      dealId: deal.id,
      workstreamId: wsSPA.id,
      authorId: liwei.id,
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-11-19"), updatedAt: d("2025-11-19") },
  });
  await prisma.task.update({
    where: { id: taskMinority.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-11-17"), updatedAt: d("2025-11-17") },
  });
  ...
  if (milestoneLOI) {
    await prisma.milestone.update({
      ...
      data: { isDone: true, date: d("2025-11-19"), updatedAt: d("2025-11-19") },
    });
  }
  logAction("Milestone completed: LOI签署 (2025-11-19), price $48M");

  // HK SPV setup done
  await prisma.task.update({
    where: { id: taskHKSPV.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-11-12"), updatedAt: d("2025-11-12") },
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 7 — Month 2-3: SPA Drafting & Negotiation (2025-11-22 to 03-20)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 7: SPA Drafting & Negotiation",
    "2025-11-22 to 2025-12-25",
  ...
  await prisma.deal.update({ where: { id: deal.id }, data: { phase: DealPhase.Negotiation, updatedAt: d("2025-11-22") } });
  ...
  const taskSPADraft = await prisma.task.create({
    data: {
      ...
      assigneeId: liwei.id,
      sortOrder: 2,
      createdAt: d("2025-11-22"),
      updatedAt: d("2025-11-27"),
    },
  });
  ...
  await prisma.task.update({
    where: { id: taskODI.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-11-22") },
  });
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "SPA起草——定义条款、交易架构、对价条款", durationMinutes: 480, isManual: true, isBillable: true, taskId: taskSPADraft.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-11-27"), updatedAt: d("2025-11-27") },
      { description: "SPA起草——陈述与保证、赔偿条款", durationMinutes: 540, isManual: true, isBillable: true, taskId: taskSPADraft.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-11-29"), updatedAt: d("2025-11-29") },
      { description: "SPA起草——交割条件、终止、其他", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskSPADraft.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-12-02"), updatedAt: d("2025-12-02") },
      { description: "ODI备案材料准备（发改委+商务部+外汇）", durationMinutes: 480, isManual: true, isBillable: true, taskId: taskODI.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-11-27"), updatedAt: d("2025-11-27") },
      { description: "反垄断申报分析：不触发中国或越南申报门槛", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskAntitrust.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-12-02"), updatedAt: d("2025-12-02") },
    ],
  });
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-12-06") },
  });
  ...
  await prisma.activityEntry.create({
    data: {
      type: ActivityType.Meeting,
      content: "SPA第一轮谈判（与Baker McKenzie视频会议）。主要争议：(1) 卖方要求整体赔偿上限为交易对价的15%，我方坚持30%；(2) 卖方不接受将药品注册续期作为交割前条件(CP)，提议改为交割后义务+赔偿；(3) Escrow金额：我方建议250万美元（约5%），卖方只接受100万美元。(4) R&W存续期：我方要求24个月，卖方18个月。下轮谈判安排在1月上旬。",
      dealId: deal.id,
      workstreamId: wsSPA.id,
      authorId: liwei.id,
      createdAt: d("2025-12-13"),
    },
  });
  ...
  await prisma.task.update({
    where: { id: taskSPANego1.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-12-15"), updatedAt: d("2025-12-15") },
  });
  await prisma.task.update({
    where: { id: taskSPANego2.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2025-12-17") },
  });
  await prisma.task.update({
    where: { id: taskSPASchedules.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-12-17"), updatedAt: d("2025-12-17") },
  });
  ...
  await prisma.task.update({
    where: { id: taskSPANego2.id },
    data: { status: TaskStatus.Done, completedAt: d("2025-12-23"), updatedAt: d("2025-12-23") },
  });

  // More time entries
  await prisma.timeEntry.createMany({
    data: [
      { description: "SPA附件及披露函起草", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskSPASchedules.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2025-12-10"), updatedAt: d("2025-12-10") },
      { description: "SPA谈判第一轮——修改陈述保证和赔偿条款", durationMinutes: 360, isManual: true, isBillable: true, taskId: taskSPANego1.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-12-13"), updatedAt: d("2025-12-13") },
      { description: "SPA谈判第二轮——交割条件和价格调整机制", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskSPANego2.id, userId: liwei.id, dealId: deal.id, createdAt: d("2025-12-22"), updatedAt: d("2025-12-22") },
      { description: "越南投资登记证(IRC)申请准备材料", durationMinutes: 360, isManual: true, isBillable: true, taskId: taskVNInvestment.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-12-15"), updatedAt: d("2025-12-15") },
    ],
  });
  ...
  const taskSPAFinal = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.InProgress,
      priority: TaskPriority.High,
      dueDate: d("2026-01-02"),
      workstreamId: wsSPA.id,
      assigneeId: liwei.id,
      sortOrder: 6,
      createdAt: d("2025-12-25"),
      updatedAt: d("2025-12-27"),
    },
  });
  ...
  const taskEscrow = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.ToDo,
      priority: TaskPriority.Normal,
      dueDate: d("2026-01-06"),
      workstreamId: wsSPA.id,
      assigneeId: zhanglin.id,
      sortOrder: 7,
      createdAt: d("2025-12-25"),
      updatedAt: d("2025-12-25"),
    },
  });
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2025-12-31"), updatedAt: d("2025-12-31") },
  });
  await prisma.task.update({
    where: { id: taskBoardApproval.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-01-02"), updatedAt: d("2026-01-02") },
  });
  await prisma.task.update({
    where: { id: taskSPAFinal.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-01-04"), updatedAt: d("2026-01-04") },
  });
  await prisma.task.update({
    where: { id: taskEscrow.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-01-06"), updatedAt: d("2026-01-06") },
  });
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "SPA最终修订及双语校对", durationMinutes: 480, isManual: true, isBillable: true, taskId: taskSPAFinal.id, userId: liwei.id, dealId: deal.id, createdAt: d("2026-01-02"), updatedAt: d("2026-01-02") },
      { description: "董事会决议及授权文件准备", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskBoardApproval.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2026-01-02"), updatedAt: d("2026-01-02") },
      { description: "少数股东waiver letter协调与签署", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskMinorityWaiver.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2025-12-31"), updatedAt: d("2025-12-31") },
      { description: "Escrow协议起草", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskEscrow.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2026-01-06"), updatedAt: d("2026-01-06") },
    ],
  });
  ...
  if (milestoneSPA) {
    await prisma.milestone.update({
      ...
      data: { isDone: true, date: d("2026-01-08"), updatedAt: d("2026-01-08") },
    });
  }
  logAction("MILESTONE: SPA签署 (2026-01-08) — SIGNING COMPLETED!");

  await prisma.activityEntry.create({
    data: {
      type: ActivityType.Note,
      content: "🎉 SPA签署完成！华瑞医疗（香港）有限公司与Viet Pharma JSC各股东签署股权购买协议。交易价格4800万美元，lock-box日期2025-10-07。Escrow 200万美元（含100万税务专项）。交割条件：(1) ODI获批, (2) 越南IRC获批, (3) 无MAC, (4) 各方CP文件齐备。预计交割日期：2026年2月底前。",
      dealId: deal.id,
      authorId: liwei.id,
      createdAt: d("2026-01-08"),
    },
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 9 — Month 4-5: Closing Preparation (2026-01-10 to 05-20)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 9: Closing Preparation",
    "2026-01-10 to 2026-02-24",
  ...
  await prisma.deal.update({ where: { id: deal.id }, data: { phase: DealPhase.Closing, updatedAt: d("2026-01-10") } });
  logAction("Deal phase advanced to Closing");

  // Create closing workstream
  const wsClosing = await prisma.workstream.create({
    data: { name: "交割清单", dealId: deal.id, sortOrder: 6, createdAt: d("2026-01-10") },
  });
  ...
  const taskODIApproval = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.InProgress,
      priority: TaskPriority.High,
      dueDate: d("2026-01-25"),
      workstreamId: wsCP.id,
      assigneeId: zhanglin.id,
      sortOrder: 1,
      createdAt: d("2026-01-10"),
      updatedAt: d("2026-01-13"),
    },
  });
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2026-01-23"), updatedAt: d("2026-01-23") },
  });
  logAction("CP satisfied: ODI approval obtained (2026-01-23)");

  await prisma.task.update({
    where: { id: taskVNInvestment.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-02-09"), updatedAt: d("2026-02-09") },
  });
  logAction("CP satisfied: Vietnam IRC obtained (2026-02-09)");
  ...
  await prisma.task.update({
    ...
    data: { status: TaskStatus.Done, completedAt: d("2026-02-16"), updatedAt: d("2026-02-16") },
  });
  await prisma.task.update({
    where: { id: taskLegalOpinion.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-02-19"), updatedAt: d("2026-02-19") },
  });
  await prisma.task.update({
    where: { id: taskSignPages.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-02-20"), updatedAt: d("2026-02-20") },
  });
  await prisma.task.update({
    where: { id: taskFundsTransfer.id },
    data: { status: TaskStatus.InProgress, updatedAt: d("2026-02-19") },
  });

  // Time entries for closing prep
  await prisma.timeEntry.createMany({
    data: [
      { description: "ODI审批沟通和材料补充", durationMinutes: 240, isManual: true, isBillable: true, taskId: taskODIApproval.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2026-01-20"), updatedAt: d("2026-01-20") },
      { description: "越南IRC申请材料审核", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskVNInvestment.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-01-25"), updatedAt: d("2026-01-25") },
      { description: "MAC确认函准备", durationMinutes: 120, isManual: true, isBillable: true, taskId: taskMACConfirm.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-02-16"), updatedAt: d("2026-02-16") },
      { description: "中国法律意见书及越南法律意见书（配合Lexcomm）", durationMinutes: 420, isManual: true, isBillable: true, taskId: taskLegalOpinion.id, userId: liwei.id, dealId: deal.id, createdAt: d("2026-02-19"), updatedAt: d("2026-02-19") },
      { description: "签字页收集及核对", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskSignPages.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2026-02-20"), updatedAt: d("2026-02-20") },
      { description: "SAFE登记及银行汇款指令准备", durationMinutes: 300, isManual: true, isBillable: true, taskId: taskFundsTransfer.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-02-22"), updatedAt: d("2026-02-22") },
    ],
  });
  ...
  // ═══════════════════════════════════════════════════════════
  // STAGE 10 — Month 5: CLOSING (2026-02-26)
  // ═══════════════════════════════════════════════════════════
  ...
  await prisma.task.update({
    where: { id: taskFundsTransfer.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-02-24"), updatedAt: d("2026-02-24") },
  });

  // Share transfer completed
  await prisma.task.update({
    where: { id: taskShareTransfer.id },
    data: { status: TaskStatus.Done, completedAt: d("2026-02-26"), updatedAt: d("2026-02-26") },
  });

  await prisma.timeEntry.createMany({
    data: [
      { description: "交割日资金到账确认及各方通知", durationMinutes: 180, isManual: true, isBillable: true, taskId: taskFundsTransfer.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-02-24"), updatedAt: d("2026-02-24") },
      { description: "股权过户及越南工商变更登记", durationMinutes: 300, isManual: true, isBillable: true, taskId: taskShareTransfer.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-02-26"), updatedAt: d("2026-02-26") },
    ],
  });
  ...
  if (milestoneClosing) {
    await prisma.milestone.update({
      ...
      data: { isDone: true, date: d("2026-02-26"), updatedAt: d("2026-02-26") },
    });
  }
  ...
  await prisma.activityEntry.create({
    data: {
      type: ActivityType.Note,
      content: "✅ 交割完成！4800万美元已汇入卖方及Escrow账户（200万美元）。股权过户已在越南完成工商变更登记。华瑞医疗通过香港SPV正式持有Viet Pharma JSC 100%股权。项目从2025年9月FA引荐至交割历时约5个半月。",
      dealId: deal.id,
      authorId: liwei.id,
      createdAt: d("2026-02-26"),
    },
  });
  logAction("MILESTONE: 交割 (2026-02-26) — DEAL CLOSED!");

  // ═══════════════════════════════════════════════════════════
  // STAGE 11 — Post-Closing & Project Close (2026-03-01 to 06-05)
  // ═══════════════════════════════════════════════════════════

  logStage(
    "Stage 11: Post-Closing & Project Close",
    "2026-03-01 to 2026-03-12",
  ...
  const taskPostNotice = await prisma.task.create({
    data: {
      ...
      status: TaskStatus.Done,
      priority: TaskPriority.Normal,
      dueDate: d("2026-03-04"),
      completedAt: d("2026-03-02"),
      workstreamId: wsClosing.id,
      assigneeId: chenyu.id,
      sortOrder: 5,
      createdAt: d("2026-02-27"),
  ...
  await prisma.timeEntry.createMany({
    data: [
      { description: "交割后各方通知（合同方、监管机构等）", durationMinutes: 120, isManual: true, isBillable: true, taskId: taskPostNotice.id, userId: chenyu.id, dealId: deal.id, createdAt: d("2026-03-02"), updatedAt: d("2026-03-02") },
      { description: "交割文件档案整理归档", durationMinutes: 360, isManual: true, isBillable: true, taskId: taskClosingBinder.id, userId: zhanglin.id, dealId: deal.id, createdAt: d("2026-03-10"), updatedAt: d("2026-03-10") },
    ],
  });
  ...
  await prisma.deal.update({
    where: { id: deal.id },
    data: { status: DealStatus.Completed, phase: DealPhase.PostClosing, updatedAt: d("2026-03-12") },
  });
  ...
  log.push("");
  log.push("### Statistics\n");
  log.push("- **Duration:** 2025-09-07 to 2026-03-12 (~6 months)");
